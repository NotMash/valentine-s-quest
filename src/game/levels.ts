...
const createLevel2 = (): LevelData => ({
  ...
  enemies: [
    { id: 1, x: 500, y: 520, width: 30, height: 30, vx: 60, vy: 0, minX: 400, maxX: 780, type: 'patrol' },
    { id: 2, x: 600, y: 520, width: 30, height: 30, vx: -40, vy: 0, minX: 500, maxX: 780, type: 'chaser', chaseSpeed: 100 },
  ],
  platforms: [
    { x: 0, y: 550, width: 800, height: 50, type: 'ground' },
...
const createLevel3 = (): LevelData => ({
  ...
  enemies: [
    // Enemies spawn far from player (player starts at x=100)
    { id: 1, x: 500, y: 520, width: 30, height: 30, vx: 70, vy: 0, minX: 400, maxX: 780, type: 'patrol' },
    { id: 2, x: 650, y: 520, width: 30, height: 30, vx: -50, vy: 0, minX: 500, maxX: 780, type: 'chaser', chaseSpeed: 120 },
    { id: 3, x: 550, y: 370, width: 25, height: 25, vx: 40, vy: 0, minX: 450, maxX: 700, type: 'jumper', jumpTimer: 0 },
  ],
  platforms: [
    { x: 0, y: 550, width: 800, height: 50, type: 'ground' },
...
const createLevel4 = (): LevelData => ({
  ...
  enemies: [
    // Enemies spawn far from player (player starts at x=100)
    { id: 1, x: 500, y: 520, width: 30, height: 30, vx: 80, vy: 0, minX: 400, maxX: 780, type: 'chaser', chaseSpeed: 130 },
    { id: 2, x: 650, y: 520, width: 30, height: 30, vx: -60, vy: 0, minX: 450, maxX: 780, type: 'chaser', chaseSpeed: 110 },
    { id: 3, x: 500, y: 250, width: 25, height: 25, vx: 50, vy: 0, minX: 400, maxX: 650, type: 'jumper', jumpTimer: 0 },
...
const createLevel5 = (): LevelData => ({
  ...
  enemies: [
    // Enemies spawn far from player
    { id: 1, x: 500, y: 520, width: 30, height: 30, vx: 90, vy: 0, minX: 400, maxX: 780, type: 'chaser', chaseSpeed: 150 },
    { id: 2, x: 650, y: 520, width: 30, height: 30, vx: -70, vy: 0, minX: 500, maxX: 780, type: 'chaser', chaseSpeed: 140 },
    { id: 3, x: 550, y: 350, width: 25, height: 25, vx: 60, vy: 0, minX: 450, maxX: 700, type: 'jumper', jumpTimer: 0 },
    { id: 4, x: 500, y: 150, width: 25, height: 25, vx: -50, vy: 0, minX: 400, maxX: 650, type: 'jumper', jumpTimer: 1.5 },
